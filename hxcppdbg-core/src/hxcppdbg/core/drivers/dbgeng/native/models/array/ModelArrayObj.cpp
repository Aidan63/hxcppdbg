...
#ifndef INCLUDED_hxcppdbg_core_drivers_dbgeng_model_DbgModelArrayModel
#include <hxcppdbg/core/drivers/dbgeng/model/DbgModelArrayModel.h>
#endif
...
hxcppdbg::core::model::ModelData hxcppdbg::core::drivers::dbgeng::native::models::array::ModelArrayObj::getHxcppdbgModelData(const Debugger::DataModel::ClientEx::Object& _object)
{
    return
        hxcppdbg::core::model::ModelData_obj::MArray(
            hxcppdbg::core::drivers::dbgeng::model::DbgModelArrayModel_obj::__new(
                cpp::Pointer<hxcppdbg::core::drivers::dbgeng::native::models::LazyArray>(new hxcppdbg::core::drivers::dbgeng::native::models::LazyArray(_object))));
}

hxcppdbg::core::model::ModelData hxcppdbg::core::drivers::dbgeng::native::models::array::ModelArrayObj::at(const Debugger::DataModel::ClientEx::Object& _object, const int _elementSize, const int _index)
{
...
{
    auto length      = _object.FieldValue(L"length").As<int>();
    auto paramName   = _object.Type().GenericArguments()[0].Name();
