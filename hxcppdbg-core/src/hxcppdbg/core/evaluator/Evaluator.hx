...
class Evaluator
{
    ...
    //                         case MMap(type) if (f == 'count'):
    //                             switch type
    //                             {
    //                                 case KInt(model):
    //                                     return Result.Success(ModelData.MInt(model.count()));
    //                                 case KString(model):
    //                                     return Result.Success(ModelData.MInt(model.count()));
    //                             }
    //                         case MAnon(fields):
    ...
    //                             //         Result.Success(items.value(ModelData.MString(key)));
    //                             //     case EConst(CInt(key)):
    //                             //         Result.Success(items.value(ModelData.MInt(key)));
    //                             //     case _:
    //                             //         Result.Error(new Exception('Unable to find item'));
    //                             // }
    //                         case other:
